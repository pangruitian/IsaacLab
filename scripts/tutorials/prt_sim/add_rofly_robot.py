...
from isaaclab_assets import CRAZYFLIE_CFG,ROFLY_CFG
...
class NewRobotsSceneCfg(InteractiveSceneCfg):
    ...
    Rofly = ROFLY_CFG.replace(prim_path="{ENV_REGEX_NS}/Rofly")
    crazy=CRAZYFLIE_CFG.replace(prim_path="{ENV_REGEX_NS}/Crazy")
